    ...
    public class SystemInterface
    {
        ...
        public Score BuildAssignment(string studentProjLocation, string instructorUnitTests, string securityCode)
        {
            ...
            try
            {
                ...
                else if (Directory.Exists("C:\\Program Files (x86)\\Microsoft Visual Studio\\2017\\Community\\VC\\Auxiliary\\Build"))
                {
                    batDirectory = "cd \"C:\\Program Files (x86)\\Microsoft Visual Studio\\2017\\Community\\VC\\Auxiliary\\Build\"";
                }
                else
                {
